...
const ShowcaseStyle2 = {
	...
	title: __( 'Vertical Showcase Style', 'blablablocks-tabs-block' ),
	content: `
           <!-- wp:group {"metadata":{"name":"Vertical Showcase Style"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"20px","right":"20px"}}},"layout":{"type":"constrained"}} -->
            ...
            <!-- wp:buttons {"style":{"spacing":{"margin":{"top":"40px"}}}} -->
            <div class="wp-block-buttons" style="margin-top:40px"><!-- wp:button {"width":100,"className":"wp-block-button__width-50","style":{"color":{"background":"#090909"},"typography":{"fontStyle":"normal","fontWeight":"500"},"border":{"radius":"6px"},"spacing":{"padding":{"left":"17px","right":"17px","top":"12px","bottom":"12px"}}},"fontSize":"medium"} -->
