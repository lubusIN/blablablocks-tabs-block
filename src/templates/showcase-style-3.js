...
const ShowcaseStyle3 = {
	name: 'showcase-style-3',
	title: __( 'Showcase Style 3', 'blablablocks-tabs-block' ),
	content: `
          <!-- wp:group {"metadata":{"name":"Showcase Style 3"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"20px","right":"20px"}}},"layout":{"type":"constrained"}} -->
